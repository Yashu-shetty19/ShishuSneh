...
public final class ActivityIntroBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout introRoot;

  private ActivityIntroBinding(@NonNull ScrollView rootView, @NonNull Button btnGetStarted,
      @NonNull Button btnSignIn, @NonNull LinearLayout introRoot) {
  ...
  public static ActivityIntroBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.introRoot;
      LinearLayout introRoot = ViewBindings.findChildViewById(rootView, id);
      if (introRoot == null) {
        break missingId;
      }

      return new ActivityIntroBinding((ScrollView) rootView, btnGetStarted, btnSignIn, introRoot);
    }
